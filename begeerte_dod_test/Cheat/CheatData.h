...
{
public:
    int FrameGen = 0x08C2F400; // 帧生成
    int RenderResolution = 0x08F364D0; // 渲染分辨率
    int FrameRateLimit = 0x08F56AC0; // 帧数上限
};
...
public:
    ...
    uintptr_t moduleBaseAddress()
    {
        ...
        {
            // 获取模块基址
            moduleBase = (uintptr_t)GetModuleHandle(L"Dragons-Win64-Test.exe");
        }
